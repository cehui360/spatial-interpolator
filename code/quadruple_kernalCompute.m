function k = quadruple_kernalCompute(x,y,para,o,normals01,normals02,k1,k2)
        d = para.d; 
        h = para.h;
        q = para.q;
        g = para.g;
        ...
        if o == 1
            ...
            k = exp(-d1/(2*d^2)).*exp(-z/(2*h^2)).*exp(-nor/(2*q^2)).*exp(-c/(2*g^2));% the quadrilateral kernel function
end
function ez = triple_predictLocal(train,test,para)
     nk = para.nc; 
     item = 1;
    ...
    for i=1:size(test,1)
        ...
        while (1)
            ...
            K = triple_kernalCompute(data,data,para,1,normals01,normals02,curvatures01,curvatures02);% the trilateral kernel function compute
            if iteration == 1
        ...
        K = triple_kernalCompute(test(i,:),data,para,3,normals01,normals02,curvatures01,curvatures02);
        P = ones(size(K,1),1);
        ez(i) = [K P]*LSCoef; 
    end   
end
